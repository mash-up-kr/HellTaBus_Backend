...
export class generate1638969738216 implements MigrationInterface {
    name = 'generate1638969738216'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`hell_ta_bus\`.\`exercise\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`part\` enum ('LOWER', 'BACK', 'CHEST', 'SHOULDER', 'BICEPS', 'TRICEPS', 'ARM') NOT NULL, \`baseCount\` int NOT NULL, \`setCount\` int NOT NULL, \`startWeight\` int NOT NULL, \`changeWeight\` int NOT NULL, \`setBreakTime\` int NOT NULL, \`breakTime\` int NOT NULL, \`imageLink\` varchar(255) NOT NULL, \`placeHolderImage\` text NOT NULL, \`priority\` int NOT NULL, \`description\` text NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
